...
// const experieneceElement = document.getElementById('experience') as HTMLTextAreaElement;
...
//      }catch(error) {
//         console.log("Shareable link failed to be copied" + error);
            ...
            shareableLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://yourdomain.com/resumes/".concat(name_1.replace(/\s+/g, "_"), "-cv.html");
                            console.log("Shareable link: " + shareableLink);
                        ...
                        case 2:
                            error_1 = _a.sent();
                            console.error("Shareable link failed to be copied: " + error_1);
                            alert("Failed to copy shareable link");
                            return [3 /*break*/, 3];
